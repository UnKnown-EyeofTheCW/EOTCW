 ...
 if (process.argv.length < 5){console.log(`Usage: node h2-reset.js URL TIME REQ_PER_SEC THREADS\nExample: node tls.js https://nbi.gov.ph 120 64 5
METHOD BY : INFRA`); process.exit();}
